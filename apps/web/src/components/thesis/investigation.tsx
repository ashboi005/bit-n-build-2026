...
import type { StageId, SourceRef, Finding, Metric, Concept, Verdict, ParsedClaim, NotCoveredData } from "@bit-n-build-2026/contracts";
...
import { NotCoveredView } from "./not-covered-view"; 
...
export function Investigation({
  ...
  return (
    <div className="w-full max-w-3xl mx-auto space-y-4">
      ...
      {notCovered ? (
        <NotCoveredView data={notCovered} />
      ) : (
        <>
          ...
          {/* Decision Capture */}
          {stages.verdict && stages.verdict.status === "done" && claim?.asset && claim?.raw && (
